...
INSERT INTO Niche (nicheID, blockID, nicheColumn, nicheRow, niche_code, status, dateOfBirth, dateOfDeath, birthCertificate, deathCertificate, occupantName) VALUES ('7897d582-8cd9-4da2-8334-7a9cc8fb6080', '4eddf318-3ca6-4df6-a669-3e90807fae11', '1', '2', '01-02', 'Pending', '1950-05-01', '2000-05-01', 'BC0001', 'DC0001', 'Occupant 1');
INSERT INTO Niche (nicheID, blockID, nicheColumn, nicheRow, niche_code, status, dateOfBirth, dateOfDeath, birthCertificate, deathCertificate, occupantName) VALUES ('e9307336-1495-48e7-9dbf-9d17255420e2', '2900250e-f165-4db2-8ec5-73a0bf344423', '2', '3', '02-03', 'Reserved', '1951-05-01', '2001-05-01', 'BC0002', 'DC0002', 'Occupant 2');
INSERT INTO Niche (nicheID, blockID, nicheColumn, nicheRow, niche_code, status, dateOfBirth, dateOfDeath, birthCertificate, deathCertificate, occupantName) VALUES ('0da1de34-e927-4864-a05a-266199be69f5', '3190ff47-bb46-4201-9b4e-6b4147c0920b', '3', '4', '03-04', 'Pending', '1952-05-01', '2002-05-01', 'BC0003', 'DC0003', 'Occupant 3');
...
INSERT INTO Payment (paymentID, amount, paymentMethod, paymentDate, paymentStatus) VALUES ('7e6494d2-7008-4edd-a015-b00838969b1d', '500.0', 'Credit Card', '2025-06-04', 'Pending');
INSERT INTO Payment (paymentID, amount, paymentMethod, paymentDate, paymentStatus) VALUES ('d9152ebc-3210-451d-942b-92faef07d4c1', '600.0', 'Credit Card', '2025-05-25', 'Cancelled');
INSERT INTO Payment (paymentID, amount, paymentMethod, paymentDate, paymentStatus) VALUES ('ba96cd40-0468-442b-8939-9bb2f74e5018', '700.0', 'Credit Card', '2025-05-15', 'Fully Paid');
