...
('28d19716-d0f8-4c90-ace1-60a8143d4c1a', 'test', 'test@mail.com', '$2b$10$61IbBFhjGqPbfNKQ9X1r/.t3IROydH.YTG1FQ0TxyfAiitumZHcW.', '$2b$10$61IbBFhjGqPbfNKQ9X1r/.', 0, '2025-06-18 14:36:11', NULL, 'Test User', '91234567', 'T1234567H', '1993-06-09', 'Singaporean', '123 Main Street, 05-23, 529536', 'Female', 'cd73d682-5aca-4bb2-8963-8a197c5fb43b'),
('79a4e4f0-5d5c-472b-95f7-bc237faffc2a', 'user', 'user@mail.com', '$2b$10$LrFWAJyBZAl7Uf.zoqBcxOvFBfiO9dLabdLlqRhw8eJmp3dGTKjoC', '$2b$10$LrFWAJyBZAl7Uf.zoqBcxO', 0, '2025-06-20 21:33:17', NULL, 'Regular User', '98765432', 'T1234568H', '1990-11-21', 'Singaporean', '456 Clementi Ave 3, 08-11, 408868', 'Male', 'cd73d682-5aca-4bb2-8963-8a197c5fb43b'),
...
-- Booked: Current → Occupied
('693aa513-05cb-43b3-8ad1-12b202b8f82e', '1b048553-e3da-484a-a76a-66108714a29d', 1, 1, '1-1-1b04', 'Occupied', '2025-06-06 08:18:47'),

-- Booked: PreOrder → Reserved
...
-- Booked: Current → Occupied
('467aace6-ca13-4939-8469-d68c05063cf7', '77435da1-e7a7-42a9-b62a-4ce60715eea7', 2, 1, '2-1-7743', 'Occupied', '2025-06-06 08:18:47'),

-- Booked: PreOrder (Cancelled) → Reserved
('ddd6422d-d914-427b-be7e-7be893619811', '77435da1-e7a7-42a9-b62a-4ce60715eea7', 2, 2, '2-2-7743', 'Reserved', '2025-06-06 08:18:47'),

-- Booked: Archived → Available
...
-- Showcasing 'Pending' for PreOrder booking (user)
('92c8ae2a-d68b-45e3-be65-14f9b344c325', '98232d67-2e53-41d5-94a0-6c52c843c3ca', 1, 2, '1-2-9823', 'Pending', '2025-06-06 08:18:47'),
...
-- Showcasing 'Pending' for PreOrder booking (test)
('d133e0f5-9d31-4b20-898d-00947c1a2b8e', '179320f9-8ea6-44fd-b67a-40c342a385c5', 1, 2, '1-2-1793', 'Pending', '2025-06-06 08:18:47'),
...
INSERT INTO Beneficiary (beneficiaryID, beneficiaryName, gender, nationality, nric, beneficiaryAddress, inscription, dateOfBirth, dateOfDeath, birthCertificate, birthCertificateMime, deathCertificate, deathCertificateMime, relationshipWithApplicant, insertedAt, lastUpdated) VALUES
('8fb6d670-06f0-4d80-bcd2-0611648e9f4f', 'John Doe', 'Male', 'Singaporean', 'S1234567A', '123 Main Street', 'In Loving Memory of John Doe', '1950-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Father', '2025-06-06 08:18:47', '2025-06-06 08:18:47'),
('27e6a7a2-82a1-4a55-ac1e-582e6dc4dbc5', 'Ng Tze Yong', 'Female', 'Singaporean', 'S2345678B', '456 Clementi Ave 3', 'In Loving Memory of Ng Tze Yong', '1951-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Mother', '2025-06-06 08:18:47', '2025-06-06 08:18:47'),
('1b4a9a6e-653a-45be-aa49-52e26bde8f82', 'Peter Tan', 'Male', 'Singaporean', 'S3456789C', '789 Bukit Timah Road', 'In Loving Memory of Peter Tan', '1952-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Father', '2025-06-06 08:18:47', '2025-06-06 08:18:47'),
('4ecb99d7-7c2d-4310-be76-0305513a1490', 'Earl Greyson', 'Male', 'Singaporean', 'S4567890D', '10 Marina Blvd', 'In Loving Memory of Earl Greyson', '1945-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Sibling', '2025-06-06 14:25:31', '2025-06-06 14:25:31'),
('0c8517f2-0b84-424d-8854-7cb96e84141e', 'Mildred Poppins', 'Female', 'Singaporean', 'S5678901E', '8 Tanjong Katong', 'In Loving Memory of Mildred Poppins', '1946-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Mother', '2025-06-06 14:25:31', '2025-06-06 14:25:31'),
('3a4bf023-58aa-4574-b2af-639ce375d92a', 'Winston Crumble', 'Male', 'Singaporean', 'S6789012F', '6 Orchard Road', 'In Loving Memory of Winston Crumble', '1947-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Father', '2025-06-06 14:25:31', '2025-06-06 14:25:31'),
('7989e00f-ec52-443d-8ca3-f1642ddd5686', 'Betsy Pickle', 'Female', 'Singaporean', 'S7890123G', '99 East Coast Road', 'In Loving Memory of Betsy Pickle', '1948-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Sibling', '2025-06-06 14:25:31', '2025-06-06 14:25:31'),
('6f3fed40-f317-4786-84c5-a093f1ba8724', 'Stanley Whisker', 'Male', 'Singaporean', 'S8901234H', '15 Holland Ave', 'In Loving Memory of Stanley Whisker', '1949-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Sibling', '2025-06-06 14:25:31', '2025-06-06 14:25:31'),
('3c15e5b3-25e2-404f-adca-c5e360a75f14', 'Nora Teacup', 'Female', 'Singaporean', 'S9012345I', '27 Commonwealth Dr', 'In Loving Memory of Nora Teacup', '1950-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Mother', '2025-06-06 14:25:31', '2025-06-06 14:25:31'),
('d95887dd-c1e4-4598-b908-db696cbb4cd6', 'Archie Bloom', 'Male', 'Singaporean', 'S0123456J', '18 Redhill Close', 'In Loving Memory of Archie Bloom', '1951-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Sibling', '2025-06-06 14:25:31', '2025-06-06 14:25:31'),
('e2addc40-cf96-403a-a3e1-2188d4617bed', 'Daisy Marlow', 'Female', 'Singaporean', 'S6543210K', '5 Bishan St 22', 'In Loving Memory of Daisy Marlow', '1952-01-01', '2020-01-01', CAST('DummyPDFBirth' AS BINARY), 'application/pdf', CAST('DummyPDFDeath' AS BINARY), 'application/pdf', 'Mother', '2025-06-06 14:25:31', '2025-06-06 14:25:31');
